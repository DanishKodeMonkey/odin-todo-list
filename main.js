...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B","sourcesContent":["body{\n    margin: 0;\n    padding: 0;\n    background-color: aqua;\n}"],"sourceRoot":""}]);
// Exports
...
function app() {
	...
	let projectsArray = []
	let projecttest = new _modules_projects__WEBPACK_IMPORTED_MODULE_2__["default"]('derp')
	projectsArray.push(projecttest)
	if (projectsArray.length === 0) {
		/* eslint-disable */console.log(...oo_oo(`1679776774_12_2_12_63_4`,'projectsArray is empty. Creating default array'))
		let defaultProject = new _modules_projects__WEBPACK_IMPORTED_MODULE_2__["default"]()
		/* eslint-disable */console.log(...oo_oo(`1679776774_14_2_14_70_4`,`default object created, name: ${defaultProject.title}`))
	} else /* eslint-disable */console.log(...oo_oo(`1679776774_15_8_15_78_4`,`Array found in projectsArray: ${projectsArray[0].title}`))
}
